...
/**
 * Created by luchfilip on 6/29/15.
 *
 */
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private ArrayList<Integer> iconsIds;
    ...
    /**
     * Set the custom layout with icons to be inflated for the tab views.
     *
     * @param layoutResId Layout id to be inflated
     * @param textViewId id of the {@link TextView} in the inflated view
     * @param iconViewId if of the icon in the inflated view
     *
     */
    public void setCustomTabIconView(int layoutResId, int textViewId, int iconViewId, ArrayList<Integer> iconsIdsResource) {
        mTabViewLayoutId = layoutResId;
        mTabViewTextViewId = textViewId;
        mTabViewIconViewId = iconViewId;
        iconsIds = iconsIdsResource;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewIconViewId != 0) {
                // if there is a custom tab view layout with icon then inflate it
                tabView = LayoutInflater.from(getContext()).inflate(mTabViewLayoutId, mTabStrip,
                        false);
                tabTitleView = (TextView) tabView.findViewById(mTabViewTextViewId);
                tabIconView = (ImageView) tabView.findViewById(mTabViewIconViewId);
                tabIconView.setImageResource(iconsIds.get(i));
