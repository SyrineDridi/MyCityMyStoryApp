...
public class MapDetailEventAPI extends Fragment implements OnMapReadyCallback{
    ...
    public static MapDetailEventAPI newInstance(Event param1) {
        MapDetailEventAPI fragment = new MapDetailEventAPI();
    ...
    public void onMapReady(GoogleMap mapi) {
      ...
      //  markerOptions.icon(BitmapDescriptor);
        ...
        LatLng place1 = new LatLng(mParam1.getLatitude(),mParam1.getLongitude());
        ...
        MapDetailEventAPI.FetchUrl FetchUrl = new MapDetailEventAPI.FetchUrl();
    ...
    private class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            MapDetailEventAPI.ParserTask parserTask = new MapDetailEventAPI.ParserTask();
